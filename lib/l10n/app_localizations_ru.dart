...
class AppLocalizationsRu extends AppLocalizations {
  ...
  @override
  String get appDescription => 'Simple Stopwatch — это лёгкое и простое в использовании приложение для измерения времени, позволяющее пользователям точно отслеживать время. Благодаря интуитивному интерфейсу пользователь может запускать, останавливать и сбрасывать секундомер одним нажатием. Идеально подходит для тренировок, учебы или любых действий, где важен контроль времени.';

  @override
  String get creditsTitle => 'Кредиты';

  @override
  String get credits => 'Разработано Askar, Alimzhan, Aselya в рамках курса «Кросс-платформенная разработка» в Astana IT University.\nНаставник (преподаватель): доцент Абзал Кызырканов';

  @override
  String get guestNotice => 'Вы используете гостевой режим. Некоторые функции могут быть недоступны.';

  @override
  String get guestNoticeDescription => 'Уведомление, показываемое, когда пользователь в гостевом режиме';
}
